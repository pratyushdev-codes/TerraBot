...
function Home() {
  ...
  const [tableCompletely, setTableCompletely] = useState({});
  ...
  useEffect(() => {
    ...
    function generateRandomValue1() {
      return Math.floor(Math.random() * 12) + 70;
    }
    ...
    // Updated to include the hardcoded sensor values
  ...
  return (
    <main className='main-container' style={{ backgroundImage: "url('/images/grad1.png')", backgroundSize: "cover" }}>
      ...
      <div className='main-cards'>
        <div className='card' style={{ borderRadius: '10px' }}>
          <div className='card-inner'>
            <h5 style={{ color: 'white' }}> <i className="fa-solid fa-heart-pulse"></i> &nbsp;Temperature</h5>
          </div>
      ...
      <p className="text-sm" style={{ color: "darkgrey" }}>Real Time Sensor data plotted in a graph for deep analysis.</p>
      <div className='charts'>
        <ResponsiveContainer width='100%' height={300}>
          ...
          >
            ...
            <Bar dataKey='gasLevel' fill='#8885D8' />
            <Bar dataKey='ldrValue' fill='#FDDF8E' />
          </BarChart>
        </ResponsiveContainer>
        <ResponsiveContainer width='100%' height={300}>
          <LineChart
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Line type='monotone' dataKey='temperature' stroke='#FF6B6B' activeDot={{ r: 8 }} />
            <Line type='monotone' dataKey='humidity' stroke='#4ECDC4' />
            <Line type='monotone' dataKey='gasLevel' stroke='#8885D8' />
            <Line type='monotone' dataKey='ldrValue' stroke='#FDDF8E' />
          </LineChart>
        </ResponsiveContainer>
      </div>
